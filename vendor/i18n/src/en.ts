...
export const en = {
  ...
  customer: {
    ...
    aiFeaturesIntro: 'Smart tools to help you shop.',
    aiFeaturesTitle: 'AI Features',
    aiMoreComingSoon: 'More AI features are on the way.',
    aiTryOnCardDesc: 'See a garment on yourself before you order it, using your camera.',
    aiTryOnWebNote: 'Camera try-on is available in the ARLI mobile app.',
    ...
    browseToTryOn: 'Browse products to try on →',
